...
class Helpers
{
    ...
    {
        return apply_filters( 'molongui_contributors/is_edit_mode', self::is_block_editor() or self::is_elementor_editor() );
    }
    public static function is_block_editor()
    {
        ...
        return apply_filters( 'molongui_contributors/is_block_editor', $edit_mode );
    }
    public static function is_elementor_editor()
    {
        ...
        return apply_filters( 'molongui_contributors/is_elementor_editor', $edit_mode );
    }
    public static function load_tidio()
    {
        if ( apply_filters( 'molongui_contributors/load_tidio', true ) )
        {
