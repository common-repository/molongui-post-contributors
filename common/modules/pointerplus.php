...
class PointerPlus {
    ...
    function admin_enqueue_assets() {
        $base_url = MOLONGUI_CONTRIBUTORS_URL; //plugins_url( '', __FILE__ );
        wp_enqueue_style( $this->prefix, $base_url . ( is_rtl() ? 'common/modules/pointerplus/assets/css/pointerplus-rtl.0390.min.css' : 'common/modules/pointerplus/assets/css/pointerplus.060f.min.css' ), array( 'wp-pointer' ), MOLONGUI_CONTRIBUTORS_VERSION );
        wp_enqueue_script( $this->prefix, $base_url . 'common/modules/pointerplus/assets/js/pointerplus.e75e.min.js?var=' . str_replace( '-', '_', $this->prefix ) . '_pointerplus', array( 'wp-pointer' ), MOLONGUI_CONTRIBUTORS_VERSION, array( 'in_footer' => true ) );
