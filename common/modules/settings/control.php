...
class Control
{
    ...
    public function __construct( $data, $group = '', $key = '', $prefix = 'molongui' )
    {
        ...
        if ( empty( $key ) ) $key = MOLONGUI_CONTRIBUTORS_PREFIX.'_options';
        ...
        $this->_upload_title 	= __( "Insert ", 'molongui-post-contributors' ) . $this->_name;
        $this->_upload_button	= __( "Choose as ", 'molongui-post-contributors' ) . $this->_name;
    ...
    private function _help()
    {
        ...
        if ( !empty( $this->_data['help'] ) )
        {
            ...
            {
                $label  = empty( $this->_data['help']['link']['label']  ) ? __( "Learn more", 'molongui-post-contributors' ) : $this->_data['help']['link']['label'];
    ...
    private function banner()
    {
        ...
        $badge  = empty( $this->_data['badge'] )    ? __( "PRO", 'molongui-post-contributors' ) : $this->_data['badge'];
                ...
                <?php foreach( $this->_data['options'] as $option ) : ?>
                    <div class="item <?php echo ( !empty( $option['disabled'] ) ? 'disabled' : '' ); ?>" data-value="<?php echo esc_attr( $option['id'] ); ?>">
                        ...
                        <?php if ( !empty( $option['disabled'] ) ) : ?>
                            <span class="description is-pro"><?php esc_html_e( "PRO", 'molongui-post-contributors' ); ?></span>
    ...
    private function textarea()
    {
        ...
        $output = apply_filters( 'molongui_contributors/option/textarea', $output, $this );
