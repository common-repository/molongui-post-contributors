...
class Bridge extends \Molongui\Contributors\Integrations\Javascript
{
    protected $name = 'bridge';
    protected $separator = '<span class="dots"><i class="fa fa-square"></i></span>';
    protected $js_target = '.post_info .post_author';
