    ...
    <article class="<?php echo join(' ', get_post_class());?>">
        <div class="td-post-header">
            ...
            <header class="td-post-title">
                ...
                <?php // MOLONGUI EDIT: Added <div> below to display the contributors below the post byline. ?>
                <div class="td-module-meta-info" style="margin-top:-14px;color: #767676;">
                    <?php molongui_the_contributor(); ?>
                </div>
            </header>
