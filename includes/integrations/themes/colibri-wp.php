...
class ColibriWP extends \Molongui\Contributors\Integrations\Javascript
{
    protected $name = 'colibri-wp';
    protected $separator = '<span class="metadata-prefix">, </span>';
    protected $js_target = '.h-blog-meta';
    ...
    {
        return '<span class="molongui-post-contributor__by metadata-prefix">';
    }
    ...
    {
        return '<span class="metadata-prefix">';
    }
