...
class Betheme extends \Molongui\Contributors\Integrations\Javascript
{
    protected $name = 'betheme';
    protected $separator = '<span>,&nbsp;</span>';
    protected $js_target = '.post-meta .author-date';
    ...
    {
        return '<div class="molongui-meta-contributor author-date" itemprop="contributor" itemscope="" itemtype="https://schema.org/Person">';
    }
