...
class TwentySixteen extends \Molongui\Contributors\Integrations\Javascript
{
    protected $name = 'twenty-sixteen';
    protected $separator = '</span><span class="contributor molongui-meta-contributor">';
    protected $js_target = '.entry-footer .byline';
    ...
    public function custom_css()
    {
        ...
        <style>
            ...
            @media screen and (min-width: 61.5625em)
            {
                ...
                .molongui-meta-contributor + .molongui-meta-contributor:before
                {
                    content: ' ';
                    display: block;
                }
