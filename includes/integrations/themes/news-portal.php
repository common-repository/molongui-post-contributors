...
class NewsPortal extends \Molongui\Contributors\Integrations\Javascript
{
    protected $name = 'news-portal';
    protected $separator = '';
    ...
    public function custom_css()
    {
        ...
        ?>
        <style>
            .molongui-meta-contributor .molongui-post-contributor__by:not(:first-of-type)
            {
                margin-left: 15px;
            }
            .molongui-meta-contributor .molongui-post-contributor__by:before
            {
                content: '\f14a';
            ...
            .molongui-meta-contributor span:not(:has(a)):hover
            {
                color: #767676;
            }
        </style>
